...
if 'APPLICATION_ENV' in os.environ:
...
if APPLICATION_ENV == 'production':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.path.join(BASE_PATH, 'db', 'sandbox.sqlite'),
            'USER': '',
            'PASSWORD': '',
            'HOST': '',
            'PORT': '',
...
if APPLICATION_ENV == 'production':
    STATIC_ROOT = '/home/static/sandbox/'
else:
    STATIC_ROOT = ''
...
SECRET_KEY = '987dd7c)!1q=lvjmfqq5pli=4+$%8hvq)hk(0!(s^ifg+l&uuj'
...
# geelweb.django.contactform config
CONTACTFORM_RECIPIENTS = ['guillaume@geelweb.org']
CONTACTFORM_SUBJECT_PREFIX = 'mail from django sandbox'
